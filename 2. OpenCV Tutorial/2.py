...
# load the input image (whose path was supplied via command line argument) and display the image
...
# all pixel values less than 225 to 255 (white; foreground) and 
...
# operation we may want to apply is to take our mask and apply a bitwise AND to our input image, keeping only the masked regions
mask = thresh.copy()
